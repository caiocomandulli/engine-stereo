...
public class Matrix3 implements Serializable {
	...
	public Matrix3 setToRotation(float degrees) {
		return setToRotationRad((float) (Math.PI / 180 * degrees));
	}
	...
	public Matrix3 setToRotation(Vector3 axis, float degrees) {
		return setToRotation(axis, (float) Math.cos(Math.PI / 180 * degrees), (float) Math.sin(Math.PI / 180 * degrees));
	}
	...
	public Matrix3 rotate(float degrees) {
		return rotateRad((float) (Math.PI / 180 * degrees));
	}
	...
	public float getRotation() {
		return (float) (180.0f / Math.PI * Math.atan2(val[M10], val[M00]));
	}
